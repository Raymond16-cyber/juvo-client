...
import PerformanceChart from "./HomePerfomanceChart";
...
function Frame({
  ...
  return (
    <div className="rounded-[1.75rem] border border-white/10 bg-white/6 p-4 shadow-[0_24px_80px_rgba(2,6,23,0.35)] backdrop-blur-xl">
      <div className="rounded-[1.25rem] border border-white/10 bg-[#0a1220]/90 p-4 sm:p-5">
        <div className="mb-4 flex items-center justify-between border-b border-white/8 pb-4">
          <div>
            <p className="text-sm font-semibold text-white">{title}</p>
            <p className="text-xs text-slate-400">{subtitle}</p>
          </div>
          <div className="rounded-full border border-white/8 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.2em] text-slate-300">
            Preview
          </div>
        </div>
        {children}
...
const showcaseSlides = [
  {
    title: "Juvo Calendar",
    subtitle: "See your trading journey at a glance.",
    body: "A compact preview of wins, losses, weekly rhythm, and monthly performance.",
    render: () => (
      <Frame title="Juvo Calendar" subtitle="Monthly rhythm preview">
        <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[1.25rem] border border-white/8 bg-white/5 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-white">August</p>
                <p className="text-xs text-slate-400">
                  Illustrative trading calendar
                </p>
              </div>
              <div className="text-right">
                ...
                <p className="text-lg font-semibold text-emerald-300">+$335</p>
              </div>
            </div>
          ...
          <div className="grid gap-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
              {[
                ["Discipline", "92%", "Plan adherence preview"],
                ["Emotional state", "Calm", "Example mood annotation"],
              ].map(([label, value, caption]) => (
                <div
                  key={label}
                  className="rounded-[1.25rem] border border-white/8 bg-[#0b1425] p-4"
                >
                  <p className="text-[11px] uppercase tracking-[0.2em] text-slate-500">
                    {label}
                  </p>
  ...
  {
    title: "Journal",
    subtitle: "Capture context, emotion, and lesson.",
    body: "Record what you traded, why you entered, what you felt, and what you learned.",
    render: () => (
      <Frame title="Journal" subtitle="Trade review preview">
        <div className="grid gap-3 lg:grid-cols-[1fr_0.9fr]">
          <div className="space-y-3 rounded-[1.25rem] border border-white/8 bg-white/5 p-4">
            {[
              ["What I traded", "Breakout continuation on session open"],
              [
                "Why I entered",
                "Trend aligned with plan and higher timeframe bias",
              ],
              ["How I felt", "Focused, slightly impatient"],
              ["Risk", "1R"],
              ["Result", "+2.4R"],
              [
                "Lesson",
                "Waited for confirmation and avoided the first impulse",
              ],
            ].map(([label, value]) => (
              <div
                key={label}
          ...
          <div className="rounded-[1.25rem] border border-white/8 bg-[#0b1425] p-4">
            <p className="text-sm font-medium text-white">Reflection prompts</p>
            <div className="mt-4 space-y-3 text-sm text-slate-300">
              {[
                "Did I follow my plan?",
                "Did emotion influence the trade?",
  ...
  },
  {
    ...
    subtitle: "Pattern detection preview.",
    body: "Illustrative insights can show how journal data turns into repeatable behavior patterns.",
    render: () => (
      <Frame title="Behavioral Insights" subtitle="Pattern detection preview">
        <div className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="grid gap-3">
            <div className="rounded-[1.25rem] border border-cyan-400/20 bg-cyan-400/8 p-4">
              <p className="text-[11px] uppercase tracking-[0.2em] text-cyan-100/70">
                Example insight
              </p>
  ...
  {
    title: "Trading Plan",
    subtitle: "Strategy and rulebook preview.",
    body: "Juvo helps traders define the rules that shape execution before the first click of the session.",
    render: () => (
      <Frame title="Trading Plan" subtitle="Strategy and rulebook preview">
        <div className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[1.25rem] border border-white/8 bg-white/5 p-4">
          ...
          <div className="space-y-3 rounded-[1.25rem] border border-white/8 bg-[#0b1425] p-4">
            {[
              ...
              <div
                key={rule}
                className="flex items-start gap-3 rounded-2xl border border-white/8 bg-white/5 p-3 text-sm text-slate-300"
              >
  ...
  {
    title: "Analytics",
    subtitle: "Performance snapshot preview.",
    body: "JUVO presents trading metrics as a story, not just a spreadsheet of numbers.",
    render: () => (
      <Frame title="Analytics" subtitle="Performance snapshot preview">
...
const pricingPlans = [
  {
    name: "Free",
    price: "Coming soon",
    desc: "For traders who want to begin journaling and establishing a consistent routine.",
    features: [
      "Basic journaling",
      "Calendar overview",
  ...
  },
  {
    name: "Pro",
    price: "Pricing TBD",
    desc: "For traders who want advanced analytics, behavioral insights, and future AI support.",
    features: [
      "Advanced analytics",
      "Behavioral insights",
      "JUVO AI Assistant",
